...
### A UE5 Landscape AutoMaterial & PCG Template Plugin

## Overview

TerraPrime is an advanced landscape automaterial plugin designed for Unreal Engine 5, specifically optimized for UE5.4, leveraging the power of Nanite for real-time displacement and detail enhancement. This plugin automates the process of texturing large landscapes by intelligently blending various layers based on height, slope, and other parameters. The included layers are:
...
TerraPrime incorporates features such as distance variation, color variation at different distances, macro and normal variation, cell bombing, and sophisticated Dirt/Grass layer blending using noise maps. The Snow, Beach, and Seabed layers are height-defined for natural transitions. It's fully compatible with Nanite in UE5.4 for displacement, ensuring high-performance and realistic terrain rendering.
